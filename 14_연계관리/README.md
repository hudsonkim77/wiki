...
| 파일 위치 | 설명 | 건수 |
|---|---|---|
| `INTERFACE.csv` (이 폴더) | 위 필드 정의를 구현한 연계 마스터 테이블 | 1건(`INTF_20260712_001`, 가상 예시 데이터) |
...
| 2026-07-12 | 관리 화면이 비어있지 않도록 첫 가상 예시 데이터 `INTF_20260712_001`("(예시)" 표기, VALIDATED_BY_TEST_ID=`TST_20260711_001`·BASELINE_ID=`BSL_20260712_001` 연결) 등록 | Claude |
